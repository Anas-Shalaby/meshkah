...
// router.get("/view/:certificateNumber", async (req, res) => {
//   try {
//     const { certificateNumber } = req.params;
//     const result = await CertificateService.viewCertificate(certificateNumber);
//     if (!result.success) {
...
//     res.json(result);
//   } catch (error) {
//     console.error("[API] Error viewing certificate:", error);
//     res.status(500).json({
//       success: false,
//       message: "حدث خطأ في عرض الشهادة",
//     });
//   }
// });
 ...
 */
router.get(
  "/eligibility/:campId/:cohortNumber",
  authMiddleware,
  async (req, res) => {
    try {
      const userId = req.user.id;
