...
app.use("/api/admin", require("./routes/queueAdmin")); // إدارة Queue الإشعارات
...
// Initialize notification queue worker (BullMQ)
// This worker processes Telegram and email notifications in the background
