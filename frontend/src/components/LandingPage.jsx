...
import RamadanCountdown from "./ramadan/RamadanCountdown";
import RamadanFloatingElements from "./ramadan/RamadanFloatingElements";
...
const LandingPage = ({ language = "ar" }) => {
  ...
  return (
    <div
      ...
      style={{ direction: "rtl" }}
    >
      {/* Ramadan Background - Fixed with high z-index */}
      {isRamadanThemeActive && (
        <div
          className="fixed inset-0 ramadan-bg-gradient"
          style={{ zIndex: -1 }}
        />
      )}
      ...
      <div className={isRamadanThemeActive ? "pt-28 md:pt-16" : ""}>
        {/* Animated Background */}
        {!isRamadanThemeActive && (
          <div
